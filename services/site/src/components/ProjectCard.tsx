...
export default function ProjectCard({
  ...
  return (
    <>
      ...
      >
        <div className={`p-4 flex flex-col ${gradient} from-primary to-secondary rounded-lg border border-accent shadow-2xl shadow-background items-center`}>
          <img alt="" draggable={false} className="rounded-lg border border-accent mb-4 duration-300" src={cardImage} />
        ...
        <Modal open={modalOpen} setOpen={setModalOpen}>
          ...
          <div className="flex lg:flex-row flex-col justify-between mt-6 px-3">
            ...
            <div className="flex flex-col">
              <h2 className="sm:text-2xl text-2xl font-semibold">Project Overview</h2>
