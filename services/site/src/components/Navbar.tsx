    ...
    <>
      ...
      >
        <nav
          ...
          className="flex h-14 max-w-184 w-screen bg-linear-to-br from-primary/90 to to-secondary/90 backdrop-blur-md rounded-lg border border-accent px-4"
        >
          <div className="flex flex-row items-center justify-between w-full">
            <div className="flex flex-row gap-2 items-center">
              <img alt="" draggable={false} className="h-10 w-10 rounded-full border border-accent" src="/me.jpeg" />
